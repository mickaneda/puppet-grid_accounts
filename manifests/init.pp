...
#    notify { "accounts......": }
    ...
    Grid_accounts::Delete_users["pool_users"] -> Grid_accounts::Delete_groups["pool_groups"] -> Grid_accounts::Delete_homedirs["pool_homedirs"] -> Grid_accounts::Delete_expsoft["expsoft"]
