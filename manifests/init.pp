...
#    notify { "accounts......": }
    ...
    Create_groups["pool_groups"] -> Create_users["pool_users"] -> Create_homedirs["pool_homedirs"]
    ...
    Delete_users["pool_users"] -> Delete_groups["pool_groups"] -> Delete_homedirs["pool_homedirs"]
